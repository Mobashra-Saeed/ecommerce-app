...
@Component({
  ...
  <div class="flex items-center gap-1 sm:gap-2">
    ...
    @if (store.isLoggedIn()) {
      <div class="flex items-center gap-1 sm:gap-2 ml-1 sm:ml-2 pl-2 sm:pl-4 border-l border-gray-200">
        <!-- Removed the JD avatar div from here -->
      ...
      <div class="flex items-center gap-1 sm:gap-2 ml-1 sm:ml-2 pl-2 sm:pl-4 border-l border-gray-200">
        ...
        <button matButton="filled" routerLink="/sign-up" class="!text-xs sm:!text-sm !px-2 sm:!px-4">Sign up</button>
      </div>
    }
  </div>`,
  styles: ``,
